...
| `tf_data_pipeline` | ✔ Passed | tf.data pipeline active with AUTOTUNE, Caching, Prefetching & Batching. Sample batch tensor shape: (32, 224, 224, 3), dtype: <dtype: 'float32'> |
...
| `predict_engine` | ✔ Passed | Prediction completed on sample image 'LHJ00208.jpg'. Predicted: 'Healthy Leaf' (Confidence: 0.2779) |
