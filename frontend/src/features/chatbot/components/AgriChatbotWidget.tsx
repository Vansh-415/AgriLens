    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 p-3.5 bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 flex items-center gap-2 group border-2 border-white/20 cursor-pointer"
      ...
      {isOpen && (
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 w-full max-w-md bg-white dark:bg-earth-900 rounded-3xl shadow-2xl border border-earth-200 dark:border-earth-700 flex flex-col h-[580px] overflow-hidden font-sans transition-all">
